...
public interface CONSTANTS extends CONSTANT_VALIDATION {
    ...
    List<String> PRODUCT_IMAGES = Arrays.asList(
    ...
    List<String> PRODUCT_CATEGORIES = Arrays.asList(
            "men's clothing",
            "jewelery",
            "electronics",
            "women's clothing"
    ...
    List<Double> PRODUCT_PRICES = Arrays.asList(
            109.95, 22.3, 55.99, 15.99, 695.0, 168.0, 9.99, 10.99, 64.0, 109.0,
            109.0, 114.0, 599.0, 999.99, 56.99, 29.95, 39.99, 9.85, 7.95, 12.99
    );

    List<String> PRODUCT_DESCRIPTIONS = Arrays.asList(
